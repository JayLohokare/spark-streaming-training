...
def main(args: Array[String]) {
  ...
  //Solution
  val pi2 : Double = 3.14159265
  val piDouble : Double = pi2 * 2
  val stringPi : String = piDouble.toString
  println(f"Pi is about $piDouble%.3f")
